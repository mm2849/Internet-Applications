...
if ($user_id < 1) {
    $user_id = get_user_id(); //Getting ID When logged in
}
$its_me = $user_id == get_user_id();
$is_edit = isset($_GET["edit"]);
?>
<?php
if ($its_me && $is_edit && isset($_POST["save"])) {
...
if ($user_id > 0) {
    ...
    try {
        ...
        if ($r) {
            ...
            flash("Couldnt find user profile", "warning");
        }
    } catch (PDOException $e) {
