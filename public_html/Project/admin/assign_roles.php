                ...
                <tr>
                    ...
                    <td>
                        <?php foreach ($active_roles as $role) : ?>
                            <div>
                                <?php render_input(["type" => "checkbox", "id"=> "role_".se($role,'id', "", false), "name" => "roles[]", "label" => se($role, "name", "", false), "value" => se($role, 'id', "", false)]); /*lazy value to check if form submitted, not ideal*/ ?>
                            </div>
                        <?php endforeach; ?>
                    </td>
                </tr>
