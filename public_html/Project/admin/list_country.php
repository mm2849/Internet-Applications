...
$table = ["data" => $results, "title" => "Countries", "ignored_columns" => ["id"], "edit_url" => get_url("admin/edit_country.php?"), "delete_url" => get_url("admin/delete_country.php?"), "view_url" => get_url("admin/view_country.php")];
